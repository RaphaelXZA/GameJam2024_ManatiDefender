...
namespace kelp_eater
{
    public class ScreenCalculateInstance : MonoBehaviour
    {
        ...
        void ArrangeObjects()
        {
            ...
            float startX = -screenWidthInWorldUnits / 2 + marginTop * 3;
            float endX = screenWidthInWorldUnits / 2 - marginTop * 3;
            ...
            for (int i = 0; i < numberOfObjects && i < objectPrefabs.Length; i++)
            {
                ...
                Vector3 spawnPosition = new Vector3(posX, -14, 0); 
        ...
        void ArrangeBottomObjects()
        {
            ...
            float startX = -screenWidthInWorldUnits / 2 + marginBottom * 3;
            float endX = screenWidthInWorldUnits / 2 - marginBottom * 3;
            ...
            {
                float posX = startX + i * spaceBetweenObjects;
                Vector3 spawnPosition = new Vector3(posX, screenBottom + 3.6f, 0); 
